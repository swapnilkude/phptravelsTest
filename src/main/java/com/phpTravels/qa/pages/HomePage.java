...
public class HomePage extends TestBase{
	...
	int chckoutmonth =1;
	String comnthxp= "//*[@id='datepickers-container']/div[2]/div/div[2]/div/div[@data-month='1']";
	@FindBy(xpath="comnthxp")
	WebElement dcheckoutMonth;
	
	int checkoutDate = testutil.currentDate()+2;
	String choutdtstring = "//*[@id='datepickers-container']/div[2]/div/div[1]/div[2]/div[@data-date='"+checkoutDate+"'][@data-month='"+chckoutmonth+"']";
	
	@FindBy(xpath="chckoutmonth")
	...
	public HotelsPage quickHomePageHotelLinkPage() throws InterruptedException, ParseException {
		...
		String chckInExpectedMonth = "Feb";
		String datexp1 = "//*[@id='datepickers-container']/div[1]/div/div[1]/div[2]/div[@data-date='"+chkindate+"'][@data-month='";
		String datexp2 ="']";
		
		WebElement datepicker_cell_month = driver.findElement(By.xpath("//*[@id='datepickers-container']/div[1]/div/div[2]/div"));
	...
	public HotelsPage quickHomePageHotelLinkPage1() throws InterruptedException {
		...
		String testdate = driver.findElement(By.cssSelector("#datepickers-container > div:nth-child(1) > div > div > div.datepicker--cells.datepicker--cells-days > div:nth-child(30)")).getText();
